...
class LexicalAnalyzer:
    ...
    RESERVED_WORDS = [
        'fn', 'main', 'println', 'println!', 'int', 'const',
    ...
    TRANSITION_MATRIX = [
        ...
        [ERROR, ERROR, ERROR,     4, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR], #3
        ...
        [ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR,    15, ERROR, ERROR], #14
